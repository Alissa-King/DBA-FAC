...
```bash
pip install pandas scikit-learn pyarrow requests
```
...
| `fac_model.py` | Canonical modeling script |
| `docs/index.html` | Self-contained dashboard (GitHub Pages) |
| `outputs/fac_demo_metrics.json` | Pre-computed synthetic demo metrics |
| `outputs/fac_pilot_metrics.json` | Pre-computed pilot metrics |
